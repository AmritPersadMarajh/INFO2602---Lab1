...
def get_stats():
    ...
    for student in data:
        ...
        program = student.get('programme', 'Unknown')
...
def add(a, b):
    return jsonify({'operation': 'add', 'result of operation': a + b})

@app.route('/subtract/<int:a>/<int:b>')
def subtract(a, b):
    return jsonify({'operation': 'subtract', 'result of operation': a - b})

@app.route('/multiply/<int:a>/<int:b>')
def multiply(a, b):
    return jsonify({'operation': 'multiply', 'result of operation': a * b})

@app.route('/divide/<int:a>/<int:b>')
def divide(a, b):
    return jsonify({'operation': 'divide', 'result of operation': a / b})
